...
If (Destination_drive_Access = False) then Begin
   ...
   If (Destination_drive='í') then Write('---')
...
If (Destination_directory_Access = False) then Begin
   ...
   If (Destination_directory='í') then Write('--------')
...
DestinationDirectory:
  ...
  Else If ((SpaceDisk div 100) < Megs) and (Destination_drive <> 'í') then
