...
{ ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ } INTERFACE { ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ }
USES  DOS, video;                             { Einbinden der Units         }

{ The unit VIDEO is also included in the SWAG distribution in the CRT.SWG   }

{ ƒ Konstantendeklarationen ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ }
...
{ ƒ Typendeklarationen ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ }
TYPE  mousetype                    = (twobutton, threebutton, another);
      buttonstate                  = (buttondown, buttonup);
      direction                    = (moveright, moveleft, moveup, movedown,
nomove);

{ ƒ Variablendeklarationen ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ }
...
{ ƒ exportierte Prozeduren und Funktionen ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ }
PROCEDURE set_graphic_mouse_cursor;        { graphischen Mousecursor setzen }
PROCEDURE showmousecursor;

{ ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ } IMPLEMENTATION { ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ }
...
BEGIN
  ...
  BEGIN
    ...
    MEM[SEG0040:$0049] := 6;                  { anderen Modus vortÑuschen   }
  END;
  ...
  BEGIN                                       { und Anzahl der Tasten auch  }
    ...
    mouse_present := (AX <> 0);               { Åberhaupt Maus vorhanden?   }
...
{ ƒ Hauptprogramm der Unit ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ }
BEGIN
