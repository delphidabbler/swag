...
Begin
  ...
  Textcolor(15);Writeln('ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ');
  Writeln('');Textcolor(14);
  Writeln('Command Line Usage:  BFTIME [FILE MASK] (Log File)');
  Writeln('');Textcolor(11);
  Writeln('Ex 1: BFTIME *.ZIP                    <ฤฤฤ< No Log File');
  Writeln('Ex 2: BFTIME *.ZIP C:\LOG\BFTIME.LOG  <ฤฤฤ< Log File Used');
  Textcolor(7);
  Writeln('                 ');
  Writeln('      ณ      ณ     ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ< Path & Name Of Log File');
  Writeln('      ณ      ณ');
  Writeln('      ณ      ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ< Mask For Files To Be Updated');
  Writeln('      ณ');
  Writeln('      ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ< Executionable Program File');
...
Begin
  ...
  Begin
    ...
    Writeln(F1,'ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ');
    Close(F1);
  End;
End;
...
Begin
  ...
  Writeln('ษออออออออออออออออออออออออออออออออออออออออออออป');
  Writeln('บ -=þ BFTIME v1.0 þ=-               03/11/95 บ');
  Writeln('บ                                            บ');
  Writeln('บ      File Date And Timestamp Updater       บ');
  Writeln('บ                                            บ');
  Writeln('บ (C) 1995 Brian Leiter, All Rights Reserved บ');
  Writeln('ศออออออออออออออออออออออออออออออออออออออออออออผ');
  Textbackground(0);
End;
