{
> 2: Writing ansi screens to directly to a file.

  2.  What exactly do you mean by writing ANSI screens to a file?
      Do you mean a text mode screen to the ANSI file format,
      or interpreting an ANSI file to a text mode screen?
