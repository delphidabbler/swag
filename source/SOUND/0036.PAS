{
-> Does anyone know how to read a .MOD file in pascal? Not play a .MOD
-> just read all the pattern and track info. All the notes and stuff and
-> effects. I dont care about the instrument data and all that.
-> If so, could you please post a source or something?

I wrote a MOD sample ripper, thought about distributing it, it's rather
nice.  I wrote it in TP.  I have some doc files on MOD's you might be
interested in...

Subject: Amiga modules formaat
...
offset
                from start of sample. Multiply by two to get offset in
bytes.
...
Kaktus
                ...
                15 to 31. If it's not there, the module/song uses 15
samples
                or the text has been removed to make the module harder
to
...
I believe that file goes under the name of MODFORM.DOC, not sure.  Not
even sure where I got it.  Anyway, enjoy.
