...
begin
  textattr:=$0F;
  gotoxy(21, 9); write('ЩЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЛ');
  gotoxy(21,10); write('Колн  он  оллолн  он  он  оллолн  он  олл К');
  gotoxy(21,11); write('Колн  он  оллолн  он  он  оллолн  он  олл К');
  gotoxy(21,12); write('Колн  он  оллолн  он  он  оллолн  он  олл К');
  gotoxy(21,13); write('Колллолллолллолллолллолллолллолллолллоллл К');
  gotoxy(21,14); write('Колллолллолллолллолллолллолллолллолллоллл К');
  gotoxy(21,15); write('Колллолллолллолллолллолллолллолллолллоллл К');
  gotoxy(21,16); write('ШЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭМ');
end;
