{
 쳐>I would like to implement color codes into my on-line doors.  You know
 쳐>the type that Wildcat or PCB have.  The @ codes.  Does anyone have a
 쳐>routine that would (I assume) read in a file bite by bite and when it
 쳐>comes across the @ char it would read the next 3 bits and determine what
 쳐>action to take?
