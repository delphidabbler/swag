{
> ex. pixel in screen is x = 160, y = 100 and ground level = 190.
> Then that pixel has to drop down like a gravity affect to
> pixel.. then it would look that there were an gravity..
}
