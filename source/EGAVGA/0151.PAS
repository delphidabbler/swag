{
> Can someone explain the details of how to make game graphics
> like   in commanche over kill ?    (3d amazing graphics)

Sean was the first one to post such a routine here. Someone else made a
realy stunning fix for it. I can't recall his name though
(he was/is Russian). Here's the source:
...
var
 ctab,stab:array[0..360] of integer;
 mp,scr : ^lrgarr;
