...
Begin
  ...
  Begin
    ClrScr;
    TextColor (15); WriteLn (' Cool View v1.0 Coded בy ScrewFace CopyRight
...
{clrscr;  (*Examples*)
StringFx('   תת  Press Any Key  תת   ',(lo(windmax) div
2)-10,hi(windmax)+1,red,lightred,lightred,15,300);{clrscr;
StringFx('   תת  Press Any Key  תת   ',(27),11,red,lightred,lightred,15,50);}
